...
function Tabs({ setActiveTab, activeTab }) {
  ...
  return (
    <div className="hidden md:flex flex-col w-64 border-r border-foreground/10 bg-background/90 backdrop-blur-sm">
        <div className="flex h-16 items-center px-6 border-b border-foreground/10">
          <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-secondary via-yellow-500 to-primary">
            CareerConnect
          </h1>
        </div>
